    ...
    @else
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px; border-bottom:1px solid var(--s-border); padding-bottom:16px;">
                ...
                <div style="display:flex; align-items:center; gap:16px; flex-wrap:wrap;">
                    ...
                    @else
                        <a href="{{ route('teacher.attendance') }}" class="teacher-outline-btn" style="padding: 6px 12px; font-size:11.5px; min-height:34px; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; justify-content: center; gap: 4px; border-color:#059669; color:#059669; background-color:rgba(5,150,105,0.02);">
            ...
            <!-- Biometric manual update info notice -->
            <div style="background-color: rgba(59, 130, 246, 0.05); border: 1px solid rgba(59, 130, 246, 0.15); padding: 14px; border-radius: 12px; display: flex; gap: 10px; align-items: flex-start; margin-bottom: 20px;">
